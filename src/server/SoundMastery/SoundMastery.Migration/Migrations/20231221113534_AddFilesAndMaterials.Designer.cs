...
namespace SoundMastery.Migration.Migrations
{
    ...
    [Migration("20231221113534_AddFilesAndMaterials")]
    partial class AddFilesAndMaterials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoundMastery.Domain.Common.FileRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoundMastery.Domain.Core.Material", b =>
                {
                    b.HasOne("SoundMastery.Domain.Common.FileRecord", "File")
                        .WithMany()
